...
const resimsec = (deger) => {	
if(kontrol){
	
	 hak++; 
     if(index==deger){
		 document.getElementById(deger).src="kedi.jpg";
		 document.getElementById("kazandiId").innerHTML="Tebrikler Kazandın :) Tekrar başlamak için <span onclick=\"basla()\" class=\"link\" => buraya</span> tıkla"
		 ...
		 if(hak==2)
		    {
			 document.getElementById("kaybettiId").innerHTML="Kaybettin :( Tekrar başlamak için <span onclick=\"basla()\" class=\"link\" => buraya</span> tıkla"
